...
interface LosslessGovernanceV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "retrieveCompensationForLERC20Contract(address)": FunctionFragment;
    "retrieveCompensationForRegularContract(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "retrieveCompensationForLERC20Contract",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "retrieveCompensationForRegularContract",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class LosslessGovernanceV2 extends BaseContract {
  ...
  interface: LosslessGovernanceV2Interface;
  ...
  functions: {
    ...
    retrieveCompensationForLERC20Contract(
      _contract: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    retrieveCompensationForRegularContract(
      _contract: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
