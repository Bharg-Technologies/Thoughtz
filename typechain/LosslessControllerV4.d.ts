...
interface LosslessControllerV4Interface extends ethers.utils.Interface {
  functions: {
    ...
    "getProtectedAddressStrategy(address,address)": FunctionFragment;
    "getVersion()": FunctionFragment;
    "guardian()": FunctionFragment;
    "isAddressProtected(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getProtectedAddressStrategy",
  ...
  encodeFunctionData(
    functionFragment: "isAddressProtected",
    values: [string, string]
  ): string;
  encodeFunctionData(
...
export class LosslessControllerV4 extends BaseContract {
  ...
  interface: LosslessControllerV4Interface;
  ...
  functions: {
    ...
    dexList(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    dexList(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
