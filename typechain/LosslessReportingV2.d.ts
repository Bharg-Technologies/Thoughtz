...
interface LosslessReportingV2Interface extends ethers.utils.Interface {
  functions: {
...
export class LosslessReportingV2 extends BaseContract {
  ...
  interface: LosslessReportingV2Interface;
